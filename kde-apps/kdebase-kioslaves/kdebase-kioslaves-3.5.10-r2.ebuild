...
# $Header: /var/cvsroot/gentoo-x86/kde-frameworks/kdelibs-kioslaves/kdebase-kioslaves-3.5.10-r1.ebuild,v 1.6 2009/07/08 13:36:05 alexxy Exp $
...
RDEPEND="${DEPEND}
	virtual/ssh
	>=kde-apps/kdialog-${PV}:${SLOT}"	# for the kdeeject script used by the devices/mounthelper ioslave
DEPEND="${DEPEND}
	x11-apps/xhost"
